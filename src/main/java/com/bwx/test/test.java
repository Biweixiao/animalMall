...
public class test {
    public static void main(String[] args) throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException, KeyManagementException {
        ...
        int port;
        char[] passphrase;
//        String[] h={"aip.baidubce.com"};//这是要访问的webservice的网址
//        String name="baiduSSL";
        String[] h = {"api.weixin.qq.com"};
        String name = "weixinSSL";
        ...
        System.out.println();
        System.out.println
                ("Added certificate to keystore 'name' using alias '"
                        + alias + "'");
    }
